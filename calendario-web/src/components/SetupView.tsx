      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "1.5rem", maxWidth: "80rem", margin: "0 auto" }}>
        ...
        <div className="surface-elevated stagger" style={{ padding: "1.75rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.625rem", marginBottom: "1.5rem" }}>
            <div style={{ width: "1.75rem", height: "1.75rem", borderRadius: "0.5rem", background: "var(--accent-soft)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--accent)", fontSize: "0.875rem" }}>👥</div>
                    ...
                    {isSelf && editing && (
                      <div style={{ display: "flex", gap: "0.25rem", alignItems: "center" }}>
                        ...
                        <button onClick={() => setEditingAlias(null)}
                          style={{ background: "none", border: "1px solid var(--border)", borderRadius: "0.375rem", padding: "0.25rem 0.5rem", fontSize: "0.75rem", cursor: "pointer" }}>✕</button>
                      </div>
                    )}
                    {(isManager && !isSelf) && (
